...
class SimpleCollectionTest {
    /*оказывает основные операции проверки содержания коллекции*/
    @Test
    void generalAssert() {
    ...
    /*показывает, как можно выбрать из коллекции группу элементов
    ...
    /*AssertJ может работать с коллекциями, реализующими интерфейс java.util.Map*/
    @Test
    void assertMap() {
